...
import unoq from "@/assets/KYB/Uno Q.png";

export function ArduinoUnoQDialog() {
  return (
    <Dialog>
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold mb-4">
            Arduino Uno Q — With Diagrams & Pin-Out Details
          </DialogTitle>
        </DialogHeader>
        <div className="space-y-6">
          <div className="aspect-w-16 aspect-h-9">
            <img
              src={unoq}
              alt="Arduino Uno Q Pinout Diagram"
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              The Arduino Uno Q is a microcontroller board based on the ATmega328P. It is an enhanced 
              version of the classic Arduino Uno with improved features and specifications. It is well 
              suited for prototyping and educational electronics, allowing connections with sensors, 
              actuators, and other modules.
            </p>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  ATmega328P with improved performance
                </p>
              </div>
              <div className="space-y-2">
                <h4 className="font-medium">Operating Voltage</h4>
                <p className="text-sm text-muted-foreground">
                  5V (with improved voltage regulation)
                </p>
              </div>
              <div className="space-y-2">
                <h4 className="font-medium">Input Voltage</h4>
                <p className="text-sm text-muted-foreground">
                  7-12V (recommended)
                </p>
              </div>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Barrel Jack, USB connector, Vin, 5V, 3.3V pins, GNDs for power management.
                </p>
              </div>
              <div className="space-y-2">
                <h4 className="font-medium">Digital I/O Pins (0-13)</h4>
                <p className="text-sm text-muted-foreground">
                  Used for digital input/output. Pins 3, 5, 6, 9, 10, 11 support PWM.
                </p>
              </div>
              <div className="space-y-2">
                <h4 className="font-medium">Analog Input Pins (A0-A5)</h4>
                <p className="text-sm text-muted-foreground">
                  For reading analog sensors. They feed into ADC (Analog-to-Digital Converter).
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <li className="space-y-1">
                ...
                <span className="block text-muted-foreground">32 KB (0.5 KB used by bootloader)</span>
              </li>
              <li className="space-y-1">
