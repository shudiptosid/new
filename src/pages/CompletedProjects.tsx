...
const completedProjects = [
  {
    ...
    description:
      "Wireless sensor nodes with long-range communication and ultra-low power consumption for environmental monitoring applications.",
  ...
  },
  {
    ...
    description:
      "Intelligent home automation hub with touchscreen interface and seamless integration with various smart devices.",
  ...
  },
  {
    ...
    description:
      "Ruggedized industrial gateway for connecting legacy equipment to modern IoT platforms with edge computing capabilities.",
  ...
  },
  {
    ...
    description:
      "Compact wearable device for continuous health monitoring with advanced signal processing and wireless connectivity.",
    image: iotSensorImage,
  ...
  },
  {
    ...
    description:
      "Flight controller system for agricultural drones with precision navigation and autonomous spraying capabilities.",
    image: industrialImage,
  ...
  },
  {
    ...
    description:
      "Smart energy monitoring and management system for commercial buildings with predictive analytics.",
    image: smartHomeImage,
