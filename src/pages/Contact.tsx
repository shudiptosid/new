        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-surface-elevated/80 mb-8 max-w-2xl mx-auto leading-relaxed">
              Ready to start your embedded systems project? I'm here to help
              bring your ideas to life with expert firmware development and IoT
              solutions.
            </p>
          </div>
        </div>
              ...
              {[
                {
                  ...
                  answer:
                    "Project timelines vary based on complexity, but most prototypes take 2-4 weeks, while complete products range from 2-6 months. I provide detailed timelines during our initial consultation.",
                },
                {
                  question: "Do you work with international clients?",
                  answer:
                    "Yes! I work with clients worldwide and am experienced with remote collaboration. I maintain flexible hours to accommodate different time zones.",
                },
                {
                  question: "What's included in your consulting services?",
                  answer:
                    "Consulting includes technical architecture review, technology selection guidance, feasibility analysis, risk assessment, and strategic planning for your embedded systems project.",
                },
                {
                  question: "Can you help with existing projects?",
                  answer:
                    "Absolutely! I can assist with debugging, optimization, feature additions, or complete rewrites of existing embedded systems and firmware.",
                },
              ].map((faq, index) => (
