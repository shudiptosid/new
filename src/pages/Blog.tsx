...
const Blog = () => {
  ...
  const categories = ['All', 'Power Management', 'Security', 'Networking', 'RTOS', 'Development', 'AI/ML'];
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-surface-elevated/80 mb-8 max-w-2xl mx-auto leading-relaxed">
              In-depth articles on embedded systems, IoT development, and emerging 
              technologies in the world of connected devices.
            </p>
          </div>
        </div>
      </section>
